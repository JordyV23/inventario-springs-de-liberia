...
<head>
    ...
    <title>Bienvenido a Springers Real State🏠</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <h1
                                                                        ...
                                                                        <strong>Bienvenido a Springers Real
                                                                            State🏠</strong></h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr class="es-visible-simple-html-only">
                                                                <td class="es-m-txt-c" align="center"
                                                                    ...
                                                                    <p align="left"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        Es un placer darte la bienvenida a Springers
                                                                        Real State. Estamos muy emocionados de que te
                                                                        unas a nosotros.&nbsp;</p>
                                                                    <p align="left"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        ​</p>
                                                                    <p align="left"
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        A continuación, te proporcionamos la información
                                                                        de tu usuario para que puedas acceder a nuestra
                                                                        plataforma.</p>
                                                                </td>
                                                            </tr>
                                                            <tr class="es-visible-simple-html-only">
                                                                <td class="es-m-txt-c" align="center"
                                                                    ...
                                                                    <h3
                                                                        ...
                                                                        Usuario: <span
                                                                            style="color:#000000"><strong>${username}</strong></span>
                                                                    </h3>
                                                                </td>
                                                            </tr>
                                                            <tr class="es-visible-simple-html-only">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;padding-right:10px;padding-bottom:10px;padding-left:10px">
                                                                    <!--[if mso]><a href="https://localhost:5173/login" target="_blank" hidden>
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://localhost:5173/login" 
                style="height:40px; v-text-anchor:middle; width:105px" arcsize="50%" strokecolor="#2cb543" strokeweight="1px" fillcolor="#0d3b66">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:14px; font-weight:400; line-height:14px;  mso-text-raise:1px'>Visitar Sitio</center>
	</v:roundrect></a>
<![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                                        class="es-button-border msohide"
                                                                        style="border-style:solid;border-color:#2CB543;background:#0d3b66;border-width:0px 0px 2px 0px;display:inline-block;border-radius:30px;width:auto;mso-hide:all"><a
                                                                            href="https://localhost:5173/login"
                                                                            class="es-button" target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:18px;padding:10px 20px 10px 20px;display:inline-block;background:#0d3b66;border-radius:30px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:normal;font-style:normal;line-height:22px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #0d3b66">Visitar Sitio</a></span>
                                                                    <!--<![endif]-->
                                                                </td>
                                                            </tr>
                                                            <tr class="es-visible-simple-html-only">
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        con el acceso, no dudes en contactar a nuestro
                                                                        equipo de soporte técnico.&nbsp;</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        ​</p>
                                                                    <p
                                                                        style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                                        <em>Por favor recuerda no compartir este nombre
                                                                            de usuario con nadie.</em></p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="es-m-txt-c" align="center"
