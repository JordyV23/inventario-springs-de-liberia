...
// F-Finalizado o D-Descartado
export const closeReasons = ["F", "D"];

export const closeReasonOptions = [
  { value: closeReasons[0], label: "Mantenimiento Finalizado" },
  { value: closeReasons[1], label: "Mantenimiento Descartado" },
];
